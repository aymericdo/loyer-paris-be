...
const rangeRentsParis: EncadrementItem[] = JSON.parse(fs.readFileSync(path.join('json-data/encadrements_paris.json'), 'utf8'))
const rangeRentsLille: EncadrementItem[] = JSON.parse(fs.readFileSync(path.join('json-data/encadrements_lille.json'), 'utf8'))
