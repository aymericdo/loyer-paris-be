    ...
    test('returns clean ad', async () => {
      ...
      expect(data).toEqual({
        ...
        computedInfo: {
          ...
          max: { order: 6, value: 32.8 },
          maxAuthorized: { order: 7, value: 342.76 },
          promoPercentage: { order: 8, value: 30.76 },
        },
        isLegal: false,
    ...
    test('returns clean ad', async () => {
      ...
      expect(data).toEqual({
        ...
        computedInfo: {
          ...
          isHouse: { order: 5, value: undefined },
          max: { order: 6, value: 17.9 },
          maxAuthorized: { order: 7, value: 350.84 },
          promoPercentage: { order: 8, value: 25.75 },
        },
        isLegal: false,
