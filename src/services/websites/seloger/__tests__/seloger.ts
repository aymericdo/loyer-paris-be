...
describe('seloger', () => {
  ...
  describe('lyon', () => {
    test('returns clean ad - lyon', async () => {
      ...
      expect(data).toEqual({
        detectedInfo: {
          address: { order: 0, value: 'rue de nice 69008, Lyon' },
          hasFurniture: { order: 1, value: true },
          roomCount: { order: 2, value: null },
          surface: { order: 3, value: 25 },
          yearBuilt: { order: 4, value: null },
          isHouse: { order: 5, value: null },
          price: { order: 6, value: 1050 },
          charges: { order: 7, value: null },
          hasCharges: { order: 8, value: true },
        },
        computedInfo: {
          neighborhood: { order: 0, value: 'Zone 5' },
          hasFurniture: { order: 1, value: true },
          roomCount: { order: 2, value: 1 },
          surface: { order: 3, value: 25 },
          dateRange: { order: 4, value: '1991-2005' },
          isHouse: { order: 5, value: undefined },
          max: { order: 6, value: 25.1 },
          maxAuthorized: { order: 7, value: 627.5 },
          promoPercentage: { order: 8, value: 33.6 },
          promo: { order: 9, value: 317.5 },
        },
        isFake: false,
        isLegal: false,
