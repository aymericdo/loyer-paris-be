  ...
  describe("paris", () => {
    test("returns clean ad", async (done) => {
      const body: Mapping = {
        ...
        description: "rue amelot, limite marais, entre cirque d'hiver et bastille.\n" +
          '\n' +
  ...
  describe("lille", () => {
    test("returns clean ad", async (done) => {
      const body: Mapping = {
        ...
        description: 't3 etat neuf, 2eme etage, 53m², dans une petite residence privee, limite lille  mons-en-barœul, a 200m du metro station mons sart, 1 km euralille.\n' +
