...
export class LeboncoinScrapping {
  static scrap(data: string): LeboncoinMapping {
    ...
    const surface = document.querySelector("#grid > article div div[data-qa-id=criteria_item_square] > div > p._3eNLO._137P-.P4PEa._35DXM")
    const rooms = document.querySelector("#grid > article div div[data-qa-id=criteria_item_rooms] > div > p._3eNLO._137P-.P4PEa._35DXM")
    const furnished = document.querySelector("#grid > article div div[data-qa-id=criteria_item_furnished] > div > p._3eNLO._137P-.P4PEa._35DXM")
