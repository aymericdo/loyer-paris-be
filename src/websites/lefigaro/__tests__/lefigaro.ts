      ...
      try {
        ...
        expect(data).toEqual({
          detectedInfo: {
            ...
            yearBuilt: { order: 4, value: null },
            price: { order: 5, value: 1040 },
            charges: { order: 6, value: 88 },
            hasCharges: { order: 7, value: null },
          },
          computedInfo: {
            ...
            max: { order: 5, value: 13.3 },
            maxAuthorized: { order: 6, value: 931 },
            promoPercentage: { order: 7, value: 2.21 },
          },
          isLegal: false,
        })
